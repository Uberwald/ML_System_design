...
- Краткое описание предполагаемого дизайна и способа оценки пилота 
  - Планируется взять пользователей за период, не вошедший в обучение (октябрь, ноябрь) и посчитать для них скор, а потом проверить на нескольких топах (1 млн, 5 млн, 10 млн) конверсию
